...
<body>
	...
	<div id="main">
		<p> Branch wise min-max-avg Salary</p>
	</div>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT passyear, MIN(salary) AS min_salary, MAX(salary) AS max_salary, AVG(salary) AS avg_salary FROM alumnir where branch='$branch' and isplacedbyiit='YES' GROUP BY passyear";
